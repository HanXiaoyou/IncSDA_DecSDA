function [meanVector, noOfSample, eigenVectors, eigenValues, samplePerClass, meanPerClass] = SemiMergeSb_eig(inMean_1, inNS_1, inEVect_1, inEVal_1, samplePerClass_1, meanPerClass_1, featureLabel_1, inMean_2, inNS_2, inEVect_2, inEVal_2, samplePerClass_2, meanPerClass_2, featureLabel_2, eigenThreshold)
% -----------------------------------------------------------------------
...
% meanResidueSumRow = sum(abs(meanResidue),2);
% meanResidue = meanResidue(find(meanResidueSumRow>residueThreshold),1);
