function [meanVector, noOfSample, eigenVectors, eigenValues] = SemiGetSt(featureVectorInCol, eigenThreshold)
% -----------------------------------------------------------------------
...
[principalComponents, tmpEigVal, meanVector, ~] = SemiPCA(featureVectorInCol, eigenThreshold);
