function [result,t] = incSDA(data,option,eigenThreshold)
% Input:
%     data:
%           X_init     ------初始训练样本集矩阵D×N
...
for nupdate=0:option.n
    ...
    if(nupdate==0)
        ...
        tic;
        [m1_1, M1_1, TeigenVect_1, TeigenVal_1] = SemiGetStD(dataset_1,label_1,eigenThreshold);
        ...
        tic
        [m1_2, M1_2, TeigenVect_2, TeigenVal_2] = SemiGetStD(dataset_2,label_2, eigenThreshold);
        ...
        [outMean, outNSample, outEVect_t, outEVal_t] = SemiMergeSt(m1_1, M1_1, TeigenVect_1, TeigenVal_1, m1_2, M1_2, TeigenVect_2, TeigenVal_2,IncS, eigenThreshold);
        ...
        [DiscriminativeComponents,~] = fGetDiscriminativeComponents(outEVect_t, outEVal_t, outEVect_b, outEVal_b, eigenThreshold);
