function [result,t] = incSDAIncUnlabel_eig_forS2(data,option,eigenThreshold)
% Input:
%     data:
%           X_init     ------初始训练样本集矩阵D×N
...
for nupdate=0:option.n
    ...
    if(nupdate==0)
        ...
        tic;
        [m1_1, M1_1, TeigenVect_1, TeigenVal_1] = GetStbar_eig_forS2(dataset_1,label_1,option,eigenThreshold);
        ...
        tic
        [m1_2, M1_2, TeigenVect_2, TeigenVal_2] = GetStbar_eig_forS2(dataset_2,label_2, option,eigenThreshold);       
        % update
        ...
        outEVect_b = BeigenVect_1;        outEVal_b = BeigenVal_1;
